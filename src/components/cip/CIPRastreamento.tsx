...
import { Search, Filter, AlertTriangle, Clock, CheckCircle, Package } from 'lucide-react';
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground text-right mt-1">{pedido.setorAtual}</p>
                </div>
