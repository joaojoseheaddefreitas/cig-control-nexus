  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="CIG CONTROL"
        className={cn(
          'relative z-10 max-w-[90vw] max-h-[80vh] object-contain drop-shadow-[0_0_60px_rgba(245,158,11,0.35)] transition-transform duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)]',
          exiting && 'scale-150'
        )}
      />
